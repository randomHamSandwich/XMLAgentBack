...
INSERT INTO car (advertised, allowedkm, cdw, children_seats, city, country , km, registration_plate, street, street_number, id_user, id_car_brand, id_car_class, id_car_model, id_fuel_type, id_gearbox_type)
VALUES (1, '100', 1, '2', 'Tokyo', 'Japan', '19000', 'BG4561-TB', 'Tokugawa Blwd.', '1600', '1', 
...
INSERT INTO car (advertised, allowedkm, cdw, children_seats, city, country , km, registration_plate, street, street_number, id_user, id_car_brand, id_car_class, id_car_model, id_fuel_type, id_gearbox_type)
VALUES (1, '120', 0, '1', 'Satsuma', 'Japan', '4000','IN12345-CZ',  'Emperor Meiji Str.', '20', '1',
...
INSERT INTO car (advertised, allowedkm, cdw, children_seats, city, country , km, registration_plate, street, street_number, id_user, id_car_brand, id_car_class, id_car_model, id_fuel_type, id_gearbox_type)
VALUES (1, '100', 1, '2', 'Yokohama', 'Japan', '109000', 'NS12345-AB', 'Shigurui Str.', '101', '1',
...
INSERT INTO car (advertised, allowedkm, cdw, children_seats, city, country , km,  registration_plate, street, street_number, id_user, id_car_brand, id_car_class, id_car_model, id_fuel_type, id_gearbox_type)
VALUES (0, '200', 0, '0', 'NeoTokyo', 'Japan', '200000', 'BG12345-ZA', 'Belgrade Str.', '1389', '1',
...
INSERT INTO car (advertised, allowedkm, cdw, children_seats, city, country , km,  registration_plate, street, street_number, id_user, id_car_brand, id_car_class, id_car_model, id_fuel_type, id_gearbox_type)
VALUES (0, '130', 1, '1', 'Nagoya', 'Japan', '3000', 'BG2589-AC','ShinShin Ave.', '203', '1',
( SELECT id_car_brand FROM car_brand WHERE name ='Suzuki' ),
...
INSERT INTO car (advertised, allowedkm, cdw, children_seats, city, country , km, registration_plate, street, street_number, id_user, id_car_brand, id_car_class, id_car_model, id_fuel_type, id_gearbox_type)
VALUES (0, '300', 0, '0', 'Osaka', 'Japan', '999', 'BG8569-DS', 'DriftKings Str.', '2000', '1',
( SELECT id_car_brand FROM car_brand WHERE name ='Mitsubishi' ),
( SELECT id_car_class FROM car_class WHERE name ='Sport' ), 
